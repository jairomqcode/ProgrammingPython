...
decimal = 8.8
```  
Para mostrar el valor de las variables en la consola, utilizamos la función **print()** y dentro colocamos el nombre de la variable sin necesidad de utilizar las comillas dobles o simples.
```python
print(texto)
print(texto2)
print(numero)
